...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b4a9b876-638f-4af6-b04f-c6e54d30bce0
```

> `b4a9b876-638f-4af6-b04f-c6e54d30bce0` is the password of the certificate, you can change it to any password you want.
